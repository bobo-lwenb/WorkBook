package com.workbook.liuwb.workbook.material.nested;
...
public class NestedChildView extends LinearLayout implements NestedScrollingChild {
    ...
    public void setNestedScrollingEnabled(boolean enabled) {
        getmScrollingChildHelper().setNestedScrollingEnabled(enabled);
    }
    ...
    public void stopNestedScroll() {
        getmScrollingChildHelper().stopNestedScroll();
    }
    ...
    public boolean hasNestedScrollingParent() {
        return getmScrollingChildHelper().hasNestedScrollingParent();
    }
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow) {
        return getmScrollingChildHelper().dispatchNestedScroll(dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, offsetInWindow);
    }
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        return getmScrollingChildHelper().dispatchNestedPreScroll(dx, dy, consumed, offsetInWindow);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        getmScrollingChildHelper().onDetachedFromWindow();
    }
}
package com.workbook.liuwb.workbook.provider.base
...
class ClientActivity : AppCompatActivity() {
    ...
    private fun queryValues() {
        val cursor = contentResolver.query(STUDENT_URI, arrayOf("id", "name", "gender", "number", "score"), null, null, null)
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.workbook.liuwb.workbook.provider"

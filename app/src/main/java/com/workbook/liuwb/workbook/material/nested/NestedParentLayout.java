...
public class NestedParentLayout extends LinearLayout implements NestedScrollingParent {
    ...
    private NestedScrollingParentHelper getmScrollingParentHelper() {
        if (null == mScrollingParentHelper) {
    ...
    public void onNestedScrollAccepted(View child, View target, int nestedScrollAxes) {
        getmScrollingParentHelper().onNestedScrollAccepted(child, target, nestedScrollAxes);
    }

    /**
     * 获取嵌套滑动的轴
     * <p>
     * ViewCompat#SCROLL_AXIS_HORIZONTAL 垂直
     * ViewCompat#SCROLL_AXIS_VERTICAL 水平
     * ViewCompat#SCROLL_AXIS_NONE 都支持
     */
    @Override
    public int getNestedScrollAxes() {
        return getmScrollingParentHelper().getNestedScrollAxes();
    }
    ...
    public void onStopNestedScroll(View target) {
        getmScrollingParentHelper().onStopNestedScroll(target);
    }
